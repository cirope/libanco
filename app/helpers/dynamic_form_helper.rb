module DynamicFormHelper
  ...
  private
    ...
    def add_field_data form, association, partial = nil
    ...
    def fieldset object, form, association, partial = nil
      form.fields_for(association, object, child_index: object.object_id) do |f|
        render partial: (partial || object), locals: { f: f }
      end
    end
    ...
    def remove_icon
      content_tag :span, nil, class: 'fa fa-times-circle'
    end
