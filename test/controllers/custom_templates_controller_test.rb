...
class CustomTemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create custom_template" do
    assert_difference('CustomTemplate.count') do
      post custom_templates_url, params: { custom_template: { footer_template_id: @custom_template.footer_template_id, header_template_id: @custom_template.header_template_id, name: @custom_template.name } }
    end
  ...
  test "should update custom_template" do
    patch custom_template_url(@custom_template), params: { custom_template: { footer_template_id: @custom_template.footer_template_id, header_template_id: @custom_template.header_template_id, name: @custom_template.name } }
